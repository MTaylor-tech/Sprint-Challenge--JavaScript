...
const stego = {name: 'stegosaurus', diet: 'herbivorous', weight: '2000kg', length: '9m', period: 'Late Jurassic'};
// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceous
const raptor = {name: 'velociraptor', diet: 'carnivorous', weight: '15kg', length: '1.8m', period: 'Late Cretaceous'};
...
const universities = graduates.map(grad => grad.university).sort((a,b) => a > b);
...
*/
let displayNames = [];
zooAnimals.forEach(a => displayNames.push(`Name: ${a.animal_name}, Scientific: ${a.scientific_name}.`));
...
the reduce method takes two arguments: a callback (which itself takes two args),
and an initial value for the count.
*/
const populationTotal = zooAnimals.reduce((sum, a) => sum += a.population, 0);
